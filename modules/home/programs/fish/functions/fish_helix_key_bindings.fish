...
function fish_helix_key_bindings --description 'helix-like key bindings for fish'
    ...
    for mode in default visual
        ...
        bind -s --preset -M $mode -m insert h end-selection insert-line-under repaint-mode
        bind -s --preset -M $mode -m insert H end-selection insert-line-over repaint-mode
        # FIXME i/a should keep selection, maybe
        bind -s --preset -M $mode l "fish_helix_command insert_mode"
        bind -s --preset -M $mode L "fish_helix_command prepend_to_line"
    ...
    for mode in default visual
        ...
        bind -s --preset -M $mode j "fish_helix_command next_word_end"
        ...
        bind -s --preset -M $mode J "fish_helix_command next_long_word_end"
